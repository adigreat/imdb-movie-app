...
import {View,StylSheet,FlatList, } from 'react-native'
import {Card} from 'react-native-elements'
import axios from 'axios'
import {RFValue} from 'react-native-responsive-fontsize'
export default class RecomendedMoviesScreen extends Component{
    constructor(){
        this.state={
            data:[]
    ...
    componentDidMount() {
      ...
      getData = () => {
        const url = "http://localhost:5000/recomended-movies";
        axios
          .get(url)
          .then(response => {
